package com.cov.bloom.common.paging;
...
public class Pagenation {
    ...
    public static SelectCriteria getSelectCriteria(int pageNo, int totalCount, int limit, int buttonAmount, String sort, String searchValue) {

        /* pageNo와 totalCount가 넘어온 상태이기 때문에 페이징 처리에 필요한 나머지 변수만 선언한다.
         * */
